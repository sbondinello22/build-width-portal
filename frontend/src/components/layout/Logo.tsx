export function Logo() {
  return (
    <span className="inline-flex items-center gap-1.5 select-none">
      <span className="text-2xl font-bold tracking-tight text-[var(--text-primary)]">build</span>
      ...
      <span className="text-2xl font-medium tracking-tight text-[var(--text-primary)]">width</span>
    </span>
  );
}
